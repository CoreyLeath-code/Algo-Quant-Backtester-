...
> This section is the portfolio audit entry point for **Algo-Quant-Backtester-**. It describes an engineering promotion path; it is not a claim that the repository is already production-authorized.

[![CI](https://img.shields.io/github/actions/workflow/status/CoreyLeath-code/Algo-Quant-Backtester-/ci.yml?branch=main&label=CI)](https://github.com/CoreyLeath-code/Algo-Quant-Backtester-/actions) [![License](https://img.shields.io/github/license/CoreyLeath-code/Algo-Quant-Backtester-)](https://github.com/CoreyLeath-code/Algo-Quant-Backtester-/blob/main/LICENSE)
